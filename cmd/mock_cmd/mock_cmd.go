...
// Source: github.com/johnmanjiro13/lgotm/cmd (interfaces: CustomSearchRepository)
...
func (m *MockCustomSearchRepository) FindImage(arg0 context.Context, arg1 string) (io.Reader, error) {
	m.ctrl.T.Helper()
...
func (mr *MockCustomSearchRepositoryMockRecorder) FindImage(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FindImage", reflect.TypeOf((*MockCustomSearchRepository)(nil).FindImage), arg0, arg1)
}
